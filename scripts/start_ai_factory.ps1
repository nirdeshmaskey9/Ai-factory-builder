...
if ($tries -ge $maxTries) { Write-Host "❌ Ollama failed to start."; exit 1 }

# --- STEP 4: Start AI Factory ---
Write-Host "🧠 Starting AI Factory (Uvicorn)..."
...
try {
    ...
    Write-Host "❌ Health check failed — verify AI Factory on port 8000."
}
